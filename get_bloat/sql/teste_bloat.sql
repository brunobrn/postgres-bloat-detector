...
select  (sum(pg_catalog.pg_table_size('oban_jobs')-pg_catalog.pg_table_size('repack.table_66067'))/pg_catalog.pg_table_size('oban_jobs'))*100 as size_difference
 ...
 --
	...
	CREATE USER MAPPING FOR dbapy_database_username SERVER foreigndb_fdw OPTIONS (user 'panda_notifications_dbapy', password '123456789');
	GRANT USAGE ON FOREIGN SERVER foreigndb_fdw TO dbapy_database_username;
	CREATE SCHEMA fdw;
